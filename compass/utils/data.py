...
def get_start_positions(
    ...
    if environment.get_min_start() == -1 or environment.get_max_start() == -1:
        return None, None
...
def get_acting_keys(act_key, num_start_positions, num_problems, num_agents):
    ...
    """
    if num_start_positions is None:
        return random.split(act_key, num_problems * num_agents).reshape((num_problems, num_agents, -1))
