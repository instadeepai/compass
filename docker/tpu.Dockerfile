...
COPY --chown=$MAMBA_USER:$MAMBA_USER docker/environment_tpu.yml /tmp/environment.yml
...
ENV PATH=/opt/conda/envs/compass/bin/:$PATH APP_FOLDER=/app
...
ENV USER=eng
ENV GROUP=eng
ENV LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/opt/conda/envs/compass/lib
